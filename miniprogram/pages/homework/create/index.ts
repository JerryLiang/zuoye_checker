...
Page({
  ...
  async compressImageForRecognition(filePath: string) {
    ...
    const maxWidths = [1000, 800, 640, 520, 420, 360];
    const qualities = [0.55, 0.45, 0.35, 0.28, 0.22, 0.16];
    ...
    const compressed = await wx.compressImage({ src: currentPath, quality: 5 });
